...
#define GE_BEGIN_RTTI_MEMBERS                                                 \
   ...
   */
#define GE_RTTI_MEMBER_PLAIN_FULL(name, field, id, info)                      \
  META_Entry_##name;                                                          \
                                                                              \
...
#define GE_RTTI_MEMBER_PLAIN(name, id)                                        \
        GE_RTTI_MEMBER_PLAIN_FULL(name,                                       \
                                  name,                                       \
                                  id,                                         \
                                  geEngineSDK::RTTIFieldInfo::DEFAULT)
...
#define GE_RTTI_MEMBER_PLAIN_NAMED(name, field, id)                           \
  ...
  /**
   * @brief Same as GE_RTTI_MEMBER_PLAIN, but allows you to specify an info
   *        structure that further describes the field.
   */
#define GE_RTTI_MEMBER_PLAIN_INFO(name, id, info)                             \
        GE_RTTI_MEMBER_PLAIN_FULL(name, name, id, info)
   ...
   *        separate names for the field name and the member variable, as well
   *        as an optional info structure further describing the field.
   */
#define GE_RTTI_MEMBER_PLAIN_ARRAY_FULL(name, field, id, info)                \
  META_Entry_##name;                                                          \
                                                                              \
...
#define GE_RTTI_MEMBER_PLAIN_ARRAY(name, id)                                  \
        GE_RTTI_MEMBER_PLAIN_ARRAY_FULL(name,                                 \
                                        name,                                 \
                                        id,                                   \
                                        geEngineSDK::RTTIFieldInfo::DEFAULT)
...
#define GE_RTTI_MEMBER_PLAIN_ARRAY_NAMED(name, field, id)                     \
  ...
  /**
   * @brief Same as GE_RTTI_MEMBER_PLAIN_ARRAY, but allows you to specify an
   *        info structure that further describes the field.
   */
#define GE_RTTI_MEMBER_PLAIN_ARRAY_INFO(name, id, info)                       \
        GE_RTTI_MEMBER_PLAIN_ARRAY_FULL(name, name, id, info)
  /***************************************************************************/
   ...
   *        optional info structure further describing the field.
   */
#define GE_RTTI_MEMBER_REFL_FULL(name, field, id, info)                       \
  META_Entry_##name;                                                          \
                                                                              \
  decltype(OwnerType::field)&                                                 \
  get##name(OwnerType* obj) {                                                 \
...
#define GE_RTTI_MEMBER_REFL_NAMED(name, field, id)                            \
  ...
  /**
   * @brief Same as GE_RTTI_MEMBER_REFL, but allows you to specify an info
   *        structure that further describes the field.
   */
#define GE_RTTI_MEMBER_REFL_INFO(name, id, info)                              \
        GE_RTTI_MEMBER_REFL_FULL(name, name, id, info)
  /***************************************************************************/
   ...
   *        as an optional info structure further describing the field.
   */
#define GE_RTTI_MEMBER_REFL_ARRAY_FULL(name, field, id, info)                 \
	META_Entry_##name;                                                          \
                                                                              \
	std::common_type<decltype(OwnerType::field)>::type::value_type&             \
  get##name(OwnerType* obj, uint32 idx) {                                     \
...
#define GE_RTTI_MEMBER_REFL_ARRAY(name, id)                                   \
        GE_RTTI_MEMBER_REFL_ARRAY_FULL(name,                                  \
                                       name,                                  \
                                       id,                                    \
                                       geEngineSDK::RTTIFieldInfo::DEFAULT)
...
#define GE_RTTI_MEMBER_REFL_ARRAY_NAMED(name, field, id)                      \
  ...
  /**
   * @brief Same as GE_RTTI_MEMBER_REFL_ARRAY, but allows you to specify an
   *        info structure that further describes the field.
   */
#define GE_RTTI_MEMBER_REFL_ARRAY_INFO(name, id, info)                        \
        GE_RTTI_MEMBER_REFL_ARRAY_FULL(name, name, id, info)
  /***************************************************************************/
   ...
   *        optional info structure further describing the field.
   */
#define GE_RTTI_MEMBER_REFLPTR_FULL(name, field, id, info)                    \
  META_Entry_##name;                                                          \
                                                                              \
  decltype(OwnerType::field)                                                  \
  get##name(OwnerType* obj) {                                                 \
...
#define GE_RTTI_MEMBER_REFLPTR(name, id)                                      \
        GE_RTTI_MEMBER_REFLPTR_FULL(name,                                     \
                                    name,                                     \
                                    id,                                       \
                                    geEngineSDK::RTTIFieldInfo::DEFAULT)
...
#define GE_RTTI_MEMBER_REFLPTR_NAMED(name, field, id)                         \
        GE_RTTI_MEMBER_REFLPTR_FULL(name, field, id, RTTIFieldInfo::DEFAULT)

  /**
   * @brief Same as GE_RTTI_MEMBER_REFLPTR, but allows you to specify an info
   *        structure that further describes the field.
   */
#define GE_RTTI_MEMBER_REFLPTR_INFO(name, id, info)                           \
        GE_RTTI_MEMBER_REFLPTR_FULL(name, name, id, info)
   ...
   *        as an optional info structure further describing the field.
   */
#define GE_RTTI_MEMBER_REFLPTR_ARRAY_FULL(name, field, id, info)              \
  META_Entry_##name;                                                          \
                                                                              \
  std::common_type<decltype(OwnerType::field)>::type::value_type              \
  get##name(OwnerType* obj, uint32 idx) {                                     \
...
#define GE_RTTI_MEMBER_REFLPTR_ARRAY(name, id)                                \
        GE_RTTI_MEMBER_REFLPTR_ARRAY_FULL(name,                               \
                                          name,                               \
                                          id,                                 \
                                          geEngineSDK::RTTIFieldInfo::DEFAULT)
...
#define GE_RTTI_MEMBER_REFLPTR_ARRAY_NAMED(name, field, id)                   \
  ...
  /**
   * @brief Same as GE_RTTI_MEMBER_REFLPTR_ARRAY, but allows you to specify an
   *        info structure that further describes the field.
   */
#define GE_RTTI_MEMBER_REFLPTR_ARRAY_INFO(name, id, info)                     \
        GE_RTTI_MEMBER_REFLPTR_ARRAY_FULL(name, name, id, info)
  /***************************************************************************/
...
#define GE_END_RTTI_MEMBERS                                                   \
  ...
  class GE_UTILITY_EXPORT RTTITypeBase
  {
   public:
    ...
    /**
     * @brief Returns a handler that determines how are IReflectable objects
     *        compared for equality.
     */
    virtual ICompare&
    getCompareHandler() const {
  ...
  class RTTIType : public RTTITypeBase
  {
   public:
    ...
    getDerivedClasses() override {
      static Vector<RTTITypeBase*> s_rttiDerivedClasses;
      return s_rttiDerivedClasses;
    }
  ...
  template<class T>
  bool
  rtti_is_subclass(const SPtr<IReflectable>& object) {
    static_assert( (is_base_of<geEngineSDK::IReflectable, T>::value),
                   "Invalid data type for type checking. It needs to derive "
                   "from geEngineSDK::IReflectable.");
  ...
  template<class T>
  SPtr<T>
  rtti_cast(const SPtr<IReflectable> object) {
    if (rtti_is_subclass<T>(object)) {
